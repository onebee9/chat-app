...
const usernameDisplay = document.getElementById("user_panel");//To display connected users
...
socket.on("allUsers", (userDetails) => {
  ...
  for(let i=0; i<userDetails.lenght; i++){
    ...
    user_panel.appendChild(connectedUsers);
