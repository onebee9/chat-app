...
//Display username
  ...
  uname.textContent = username; //add the retrieved content to the created html elements
  uname.classList.add("username_Display");//Appending a style class
  usernameDisplay.appendChild(uname); //add the username to the div
