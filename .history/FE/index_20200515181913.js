...
const incomingDivs = {};
const onlineUsers = {username,room,userLang};
console.log(onlineUsers); 


// get user info from login form the login form
getInfo.addEventListener("submit", (e) => {
  e.preventDefault();

  socket.emit("connectedUsers", onlineUsers);
  console.log(onlineUsers + "iiiii");
});
...
chat_form.addEventListener("submit", (e) => {
  ...
  socket.emit("chat_message", {newMessage,onlineUsers});
  console.log({newMessage,onlineUsers});
});
