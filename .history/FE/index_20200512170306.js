...
//send through the usernames entered by people
let user_name = usernameContainer.value
socket.emit("namedUsers",user_name);
...
//recieve connected users and thier ID's
socket.on('namedUsers',(user_name)=>{
...
//recieve socket ID's i.e userID's from the server and map to the usernames
// socket.on("connectedUsersId",(connectedUsers) => {
