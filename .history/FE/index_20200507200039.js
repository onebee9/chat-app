const socket = io();
const formatMessage = require('/Users/ibifuro-odu/Documents/chat-app/FE/formatMessage.js');
...
socket.on(('message'),(msg)=>{
  ...
  messageBubble.textContent=formatMessage.message;
  messageTime.textContent=formatMessage.time;
  messageAuthor.textContent=formatMessage.username;
