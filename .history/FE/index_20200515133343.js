...
const broadcastBubble = document.createElement("div"); //To append all broadcast messages from the chatbot
const usernameDisplay = document.getElementById('username');
const incomingDivs = {};
const onlineUsers = [];

//Display username
  usernameDisplay.textContent = username; //add the retrieved content to the created html elements
  usernameDisplay.classList.add("usernameDisplay");//Appending a style class
  incomingContainer.appendChild(usernameDisplay); //add the username to the div
...
chat_form.addEventListener("submit", (e) => {
  ...
  let user_lang = window.navigator.userLanguage || window.navigator.language; //get user language
